                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
							...
							<?php echo anchor('lapakhir','Data Laporan Akhir',array('class'=>'btn btn-primary btn-sm')) ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeU">
												...
												<td class="center">
                                                    <?php echo anchor('peneliti_lapakhir/awal/'.$r->id_pengajuan,'Submit'); ?>
                                                    <!-- <?php echo anchor('lapakhir/delete/'.$r->id_antara,'Hapus'); ?> -->
                                                </td>
                                            </tr>
                                        <?php $no++; } ?>
                                        </tbody>
