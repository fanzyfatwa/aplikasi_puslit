<?php
	class Peneliti extends CI_Controller {
		function __construct(){
			parent::__construct();
			$this->load->model('model_peneliti');
		}
		public function index(){
			$data = array(	'title'	=> 'Daftar Peneliti',
						'isi'	=> 'lihat_peneliti');
			
			$data['record']=  $this->model_peneliti->tampildata();
	...
	function action()
 {
  ...
  $table_columns = array("Nama Dosen","NIP", "NIDN",  "Jurusan / Fakultas", "Logbook", "Laporan Keuangan 60%", "Draf Naskah", "Progres Artikel", "Progres HKI", "Catatan");
