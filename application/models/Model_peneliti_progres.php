...
class Model_peneliti_progres extends CI_Model{
    ...
    public function view(){
		...
		$query = $this->db->select('progres.id_progres, pengajuan.id_peneliti, pengajuan.nama_dosen, progres.pro_pub, progres.upload_file');
